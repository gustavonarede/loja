...
<div class="container-fluid">
    ...
    <div class="row" id="topo">
        ...
        <div class="container">
            ...
            <div class="col-md-6 text-right">
                ...
                <br>{if $LOGADO == true}
                Olá: {$USER} <a href="{$PAG_LOGOFF}" class="btn btn-info"><i class="glyphicon glyphicon-log-out"></i>
                Sair </a>
                <a href="{$PAG_SENHA}" class="btn btn-warning"><i class="glyphicon glyphicon-asterisk"></i>Alterar Senha
                </a> <br><br>
                <h5>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{$PAG_ADM_CLIENTE}"><i class="glyphicon glyphicon-shopping-cart"></i> Clientes </a>
                        </li>
        ...
        <div class="container">
            ...
            <div class="col-md-2" id="lateral">
                ...
                <div class="list-group">
                    ...
                    <a href="{$PAG_ADM_PRODUTOS}" class="list-group-item"><span
                                class="glyphicon glyphicon-menu-right"></span> Todos</a>

                    {foreach from=$CATEGORIAS item=C}
                        <a href="{$C.cate_link_adm}" class="list-group-item"><span
            ...
            <h4 class="text-center text-danger"> Olá Administrador <b>{$USER}</b>, seja bem vindo! O que deseja fazer
                agora?</h4>
            <section class="row">

                <div class="text-center">

                    <a href="{$PAG_CATEGORIAS}" class="btn btn-success"><i class="glyphicon glyphicon-home"></i>
                        Categorias</a>

                    <a href="{$PAG_ADM_PRODUTOS}" class="btn btn-success"><i class="glyphicon glyphicon-barcode"></i>
                        Produtos</a>

                    <a href="{$PAG_ADM_CLIENTE}" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i>
                        Clientes </a>
                    <a href="{$PAG_ADM_PEDIDOS}" class="btn btn-success"><i
                                class="glyphicon glyphicon-shopping-cart"></i> Pedidos </a>
    ...
    <div class="row" id="rodape">
        <center>
            <h4>{$TITULO_SITE}</h4>
            <P>Todos os Direitos Reservados - Rarissicima Semi Joias {$DATA}</P>
        </center>
