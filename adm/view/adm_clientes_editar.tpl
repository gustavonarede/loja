...
<form name="cadcliente" id="cadcliente" method="post" action="">
    ...
    <section class="row" id="cadastro">
        ...
        <div class="col-md-4">
            ...
            <input type="text" value="{$CLI_SOBRENOME}" name="cli_sobrenome" class="form-control" minlength="3"
                   required>
        ...
        <div class="col-md-2">
            ...
            <input type="text" value="{$CLI_UF}" name="cli_uf" class="form-control" maxlength="2" minlength="2"
                   required>
        ...
        <div class="col-md-2">
            ...
            <input type="text" value="{$CLI_CEP}" name="cli_cep" class="form-control" minlength="8" maxlength="8"
                   required>
