<?php
/* Smarty version 3.1.33, created on 2019-11-11 20:53:32
  from 'C:\xampp\htdocs\loja\adm\view\adm_index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5dc9f47c9fce23_24297958',
...
function content_5dc9f47c9fce23_24297958 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
" class="btn btn-info"><i class="glyphicon glyphicon-log-out"></i>
                Sair </a>
                <a href="<?php echo $_smarty_tpl->tpl_vars['PAG_SENHA']->value;?>
" class="btn btn-warning"><i class="glyphicon glyphicon-asterisk"></i>Alterar Senha
                </a> <br><br>
                <h5>
...
"><i class="glyphicon glyphicon-shopping-cart"></i> Clientes </a>
                        </li>
...
</b>, seja bem vindo! O que deseja fazer
                agora?</h4>
            <section class="row">
...
" class="btn btn-success"><i class="glyphicon glyphicon-home"></i>
                        Categorias</a>

                    <a href="<?php echo $_smarty_tpl->tpl_vars['PAG_ADM_PRODUTOS']->value;?>
" class="btn btn-success"><i class="glyphicon glyphicon-barcode"></i>
                        Produtos</a>
...
" class="btn btn-danger"><i class="glyphicon glyphicon-log-out"></i> Sair </a>
    ...
    <div class="row" id="rodape">
        <center>
            ...
            <P>Todos os Direitos Reservados - Rarissicima Semi Joias <?php echo $_smarty_tpl->tpl_vars['DATA']->value;?>
</P>
        </center>
