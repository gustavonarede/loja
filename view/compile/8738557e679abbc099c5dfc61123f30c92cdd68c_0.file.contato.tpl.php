<?php
/* Smarty version 3.1.33, created on 2019-09-27 01:05:39
  from 'C:\wamp64\www\loja\view\contato.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d8d8a935ad585_30359137',
...
function content_5d8d8a935ad585_30359137 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="container">
    <div class="row">
        ...
        <form class="form-horizontal" id="frmcontatoazul" action="envio">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="txtinputnome" name="txtinputnome" placeholder="Escreva seu nome completo"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="txtinputemail" name="txtinputemail" placeholder="Coloque um email válido"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea class="form-control" id="txtinputarea" rows="6" name="txtinputarea"
